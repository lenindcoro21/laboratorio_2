     ...
     return Scaffold( 
       body: Container(
         child: ListView(children:<Widget> [
           ...
           child: TextInput(hintText:"Name",inputType: TextInputType.name,controller: _controllerName,maxLineas: 1, hint: 'Name',),

           ),//Nomnre
           
           Container(margin: EdgeInsets.only(top:15.0),
           child: TextInput(hintText:"Hobbies and interest",inputType: TextInputType.text,
           controller: _controllerHobbies,maxLineas: 6, hint: 'Hobbies and interest',)),//Hobbies
           Container(
